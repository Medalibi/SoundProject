...
elseif opr == 2
    fNorm = 2000 / (handles.Fe/2);
    [handles.num,handles.dem] = butter(10, fNorm, 'low');
    handles.x1 = filtfilt(handles.num, handles.dem, handles.x);
elseif opr == 3
    ...
    handles.x1=filter(handles.num,handles.dem,handles.x);
elseif opr == 4
    fNorm = 3000 / (handles.Fe/2);
    [handles.num, handles.dem] = butter(10, fNorm, 'high');
    handles.x1 = filtfilt(handles.num, handles.dem, handles.x);
end;

subplot(2,4,5),plot(handles.x1);
guidata(hObject, handles);
